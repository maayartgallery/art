window.addEventListener("DOMContentLoaded", () => {
        ...
        function autoImageSlider(card, folder) {
            ...
            function preloadNext() {
                const img = new Image();
                img.src = `images/${folder}/${index}.jpg`;
            ...
            function startSlider() {
                front.src = `images/${folder}/${images[0]}.jpg`;

                setInterval(() => {
                    const nextIndex = (current + 1) % images.length;
                    back.src = `images/${folder}/${images[nextIndex]}.jpg`;
        ...
        window.showGallery = function (folder) {
            ...
            function loadNext() {
                const imgPath = `images/${folder}/${index}.jpg`;
                const img = new Image();
                img.src = imgPath;
        ...
        window.handleSubmit = function(event) {
            ...
            emailjs.sendForm(
                "service_f05hrny",    // Your Service ID
                "template_8enb95h",   // Your Template ID
                form,
                "zQPuiBz4dcjJz1wbJ"  // Your Public Key
            ).then(
                function(response) {
